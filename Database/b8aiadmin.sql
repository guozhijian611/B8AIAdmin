...
-- ----------------------------
BEGIN;
INSERT INTO `sa_site_info` (`id`, `site_name`, `site_logo`, `site_desc`, `site_keywords`, `site_copyright`, `site_record_number`, `site_config`, `contact`, `remark`, `create_time`, `update_time`, `delete_time`) VALUES (1, 'B8AIAdmin', '', 'B8AIAdmin 可配置品牌的中后台管理系统', NULL, '', '', '', '15888888888', '', '2026-01-18 21:09:49', '2026-01-18 23:06:26', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sa_system_config` (`id`, `group_id`, `key`, `value`, `name`, `input_type`, `config_select_data`, `sort`, `remark`, `created_by`, `updated_by`, `create_time`, `update_time`, `delete_time`) VALUES (1, 1, 'site_copyright', 'Copyright © 2026 B8AIAdmin', '版权信息', 'textarea', NULL, 96, '', 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO `sa_system_config` (`id`, `group_id`, `key`, `value`, `name`, `input_type`, `config_select_data`, `sort`, `remark`, `created_by`, `updated_by`, `create_time`, `update_time`, `delete_time`) VALUES (2, 1, 'site_desc', 'B8AIAdmin 可配置品牌的中后台管理系统', '网站描述', 'textarea', NULL, 97, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO `sa_system_config` (`id`, `group_id`, `key`, `value`, `name`, `input_type`, `config_select_data`, `sort`, `remark`, `created_by`, `updated_by`, `create_time`, `update_time`, `delete_time`) VALUES (3, 1, 'site_keywords', 'B8AIAdmin,后台管理系统', '网站关键字', 'input', NULL, 98, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO `sa_system_config` (`id`, `group_id`, `key`, `value`, `name`, `input_type`, `config_select_data`, `sort`, `remark`, `created_by`, `updated_by`, `create_time`, `update_time`, `delete_time`) VALUES (4, 1, 'site_name', 'B8AIAdmin', '网站名称', 'input', NULL, 99, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO `sa_system_config` (`id`, `group_id`, `key`, `value`, `name`, `input_type`, `config_select_data`, `sort`, `remark`, `created_by`, `updated_by`, `create_time`, `update_time`, `delete_time`) VALUES (5, 1, 'site_record_number', '', '网站备案号', 'input', NULL, 95, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO `sa_system_config` (`id`, `group_id`, `key`, `value`, `name`, `input_type`, `config_select_data`, `sort`, `remark`, `created_by`, `updated_by`, `create_time`, `update_time`, `delete_time`) VALUES (302, 1, 'site_logo', '', '站点Logo', 'uploadImage', NULL, 94, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
INSERT INTO `sa_system_config` (`id`, `group_id`, `key`, `value`, `name`, `input_type`, `config_select_data`, `sort`, `remark`, `created_by`, `updated_by`, `create_time`, `update_time`, `delete_time`) VALUES (303, 1, 'site_favicon', '', '站点Favicon', 'uploadImage', NULL, 93, NULL, 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
...
INSERT INTO `sa_system_config` (`id`, `group_id`, `key`, `value`, `name`, `input_type`, `config_select_data`, `sort`, `remark`, `created_by`, `updated_by`, `create_time`, `update_time`, `delete_time`) VALUES (10, 2, 'upload_size', '52428800', '上传大小', 'input', NULL, 88, '单位Byte,1MB=1024*1024Byte', 1, 1, '2026-01-01 00:00:00', '2026-01-01 00:00:00', NULL);
