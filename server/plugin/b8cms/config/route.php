...
if ($sitePath !== '') {
    ...
    Route::get($sitePath . '/', [SiteViewController::class, 'redirectWithoutTrailingSlash']);
}
Route::get($sitePath ?: '/', [SiteViewController::class, 'home']);
Route::get($sitePath . '/{lang:[A-Za-z]{2}-[A-Za-z]{2}}', [SiteViewController::class, 'home']);
Route::get($sitePath . '/{lang:[A-Za-z]{2}-[A-Za-z]{2}}/', [SiteViewController::class, 'redirectWithoutTrailingSlash']);
